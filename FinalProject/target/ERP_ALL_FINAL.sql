...
-- 카라멜 마끼야또 1392.5원
(2, 'Coffee', 'Regular', 1, '카라멜마끼야또', 20, 'g', 20, 20 * 20),       -- 원두(에스프레소)
(2, 'Coffee', 'Regular', 3, '카라멜마끼야또', 15, 'ml', 1.5, 15 * 1.5),    -- 카라멜 시럽
(2, 'Coffee', 'Regular', 4, '카라멜마끼야또', 100, 'ml', 3, 100 * 3),      -- 우유
(2, 'Coffee', 'Regular', 6, '카라멜마끼야또', 150, 'ml', 2, 150 * 2),      -- 얼음
(2, 'Coffee', 'Regular', 7, '카라멜마끼야또', 1, 'ea', 70, 70),            -- 컵(regular size)
...
-- 헤이즐넛 아메리카노 970원
(7, 'Coffee', 'Regular', 1, '헤이즐넛아메리카노', 20, 'g', 20, 20 * 20),       -- 원두(에스프레소)
(7, 'Coffee', 'Regular', 5, '헤이즐넛아메리카노', 15, 'ml', 10, 15 * 10),      -- 헤이즐넛 시럽
(7, 'Coffee', 'Regular', 2, '헤이즐넛아메리카노', 100, 'ml', 0.2, 100 * 0.2),  -- 물
(7, 'Coffee', 'Regular', 6, '헤이즐넛아메리카노', 150, 'ml', 2, 150 * 2),      -- 얼음
(7, 'Coffee', 'Regular', 7, '헤이즐넛아메리카노', 1, 'ea', 70, 70),            -- 컵(regular size)

-- 바닐라 아메리카노 1220원
(8, 'Coffee', 'Regular', 1, '바닐라아메리카노', 20, 'g', 20, 20 * 20),         -- 원두(에스프레소)
(8, 'Coffee', 'Regular', 5, '바닐라아메리카노', 15, 'ml', 10, 15 * 10),        -- 바닐라 시럽
(8, 'Coffee', 'Regular', 2, '바닐라아메리카노', 100, 'ml', 0.2, 100 * 0.2),    -- 물
(8, 'Coffee', 'Regular', 6, '바닐라아메리카노', 150, 'ml', 2, 150 * 2),        -- 얼음
(8, 'Coffee', 'Regular', 7, '바닐라아메리카노', 1, 'ea', 70, 70),              -- 컵(regular size)
...
-- 에스프레소(레귤러) 470원
(14, 'Coffee', 'Regular', 1, '에스프레소', 20, 'g', 20, 20 * 20),      -- 원두(에스프레소)
(14, 'Coffee', 'Regular', 8, '에스프레소', 1, 'ea', 70, 70),           -- 컵(regular size)



-- 엑스트라-----------------------------------------------------------------------
-- 아메리카노 1210원
(1, 'Coffee', 'Extra', 1, '아메리카노', 30, 'g', 20, 30 * 20),     -- 원두(에스프레소)
(1, 'Coffee', 'Extra', 2, '아메리카노', 150, 'ml', 0.2, 150 * 0.2), -- 물
(1, 'Coffee', 'Extra', 6, '아메리카노', 250, 'ml', 2, 250 * 2),     -- 얼음
(1, 'Coffee', 'Extra', 8, '아메리카노', 1, 'ea', 80, 80),           -- 컵(extra size)

-- 카라멜 마끼야또 1660원
(2, 'Coffee', 'Extra', 1, '카라멜 마끼야또', 30, 'g', 20, 30 * 20),    -- 원두(에스프레소)
(2, 'Coffee', 'Extra', 3, '카라멜 마끼야또', 20, 'ml', 1.5, 20 * 1.5),  -- 카라멜 시럽
(2, 'Coffee', 'Extra', 4, '카라멜 마끼야또', 150, 'ml', 3, 150 * 3),    -- 우유
(2, 'Coffee', 'Extra', 6, '카라멜 마끼야또', 250, 'ml', 2, 250 * 2),    -- 얼음
(2, 'Coffee', 'Extra', 8, '카라멜 마끼야또', 1, 'ea', 80, 80),          -- 컵(extra size)

-- 카페라떼 1630원
(3, 'Coffee', 'Extra', 1, '카페라떼', 30, 'g', 20, 30 * 20),           -- 원두(에스프레소)
(3, 'Coffee', 'Extra', 4, '카페라떼', 150, 'ml', 3, 150 * 3),          -- 우유
(3, 'Coffee', 'Extra', 6, '카페라떼', 250, 'ml', 2, 250 * 2),          -- 얼음
(3, 'Coffee', 'Extra', 8, '카페라떼', 1, 'ea', 80, 80),                -- 컵(extra size)

-- 바닐라라떼 1830원
(4, 'Coffee', 'Extra', 1, '바닐라라떼', 30, 'g', 20, 30 * 20),         -- 원두(에스프레소)
(4, 'Coffee', 'Extra', 4, '바닐라라떼', 150, 'ml', 3, 150 * 3),        -- 우유
(4, 'Coffee', 'Extra', 5, '바닐라라떼', 20, 'ml', 10, 20 * 10),        -- 바닐라 시럽
(4, 'Coffee', 'Extra', 6, '바닐라라떼', 250, 'ml', 2, 250 * 2),        -- 얼음
(4, 'Coffee', 'Extra', 8, '바닐라라떼', 1, 'ea', 80, 80),              -- 컵(extra size)

-- 카푸치노 1630원
(5, 'Coffee', 'Extra', 1, '카푸치노', 30, 'g', 20, 30 * 20),           -- 원두(에스프레소)
(5, 'Coffee', 'Extra', 4, '카푸치노', 150, 'ml', 3, 150 * 3),          -- 우유
(5, 'Coffee', 'Extra', 6, '카푸치노', 250, 'ml', 2, 250 * 2),          -- 얼음
(5, 'Coffee', 'Extra', 8, '카푸치노', 1, 'ea', 80, 80),                -- 컵(extra size)

-- 헤이즐넛라떼 1830원
(6, 'Coffee', 'Extra', 1, '헤이즐넛라떼', 30, 'g', 20, 30 * 20),       -- 원두(에스프레소)
(6, 'Coffee', 'Extra', 4, '헤이즐넛라떼', 150, 'ml', 3, 150 * 3),      -- 우유
(6, 'Coffee', 'Extra', 5, '헤이즐넛라떼', 20, 'ml', 10, 20 * 10),      -- 헤이즐넛 시럽
(6, 'Coffee', 'Extra', 6, '헤이즐넛라떼', 250, 'ml', 2, 250 * 2),      -- 얼음
(6, 'Coffee', 'Extra', 8, '헤이즐넛라떼', 1, 'ea', 80, 80),           -- 컵(extra size)



-- 헤이즐넛 아메리카노 1410원
(7, 'Coffee', 'Extra', 1, '헤이즐넛아메리카노', 30, 'g', 20, 30 * 20),       -- 원두(에스프레소)
(7, 'Coffee', 'Extra', 5, '헤이즐넛 아메리카노', 20, 'ml', 10, 20 * 10),     -- 헤이즐넛 시럽
(7, 'Coffee', 'Extra', 2, '헤이즐넛 아메리카노', 150, 'ml', 0.2, 150 * 0.2), -- 물
(7, 'Coffee', 'Extra', 6, '헤이즐넛 아메리카노', 250, 'ml', 2, 250 * 2),     -- 얼음
(7, 'Coffee', 'Extra', 8, '헤이즐넛 아메리카노', 1, 'ea', 80, 80),           -- 컵(extra size)

-- 바닐라 아메리카노 1410원
(8, 'Coffee', 'Extra', 1, '바닐라아메리카노', 30, 'g', 20, 30 * 20),         -- 원두(에스프레소)
(8, 'Coffee', 'Extra', 5, '바닐라아메리카노', 20, 'ml', 10, 20 * 10),       -- 바닐라 시럽
(8, 'Coffee', 'Extra', 2, '바닐라아메리카노', 150, 'ml', 0.2, 150 * 0.2),   -- 물
(8, 'Coffee', 'Extra', 6, '바닐라아메리카노', 250, 'ml', 2, 250 * 2),       -- 얼음
(8, 'Coffee', 'Extra', 8, '바닐라아메리카노', 1, 'ea', 80, 80),             -- 컵(extra size)

-- 콜드브루라떼(엑스트라) 1630원
(10, 'Coffee', 'Extra', 1, '콜드브루라떼', 30, 'g', 20, 30 * 20),             -- 원두(에스프레소)
(10, 'Coffee', 'Extra', 4, '콜드브루라떼', 150, 'ml', 3, 150 * 3),           -- 우유
(10, 'Coffee', 'Extra', 6, '콜드브루라떼', 250, 'ml', 2, 250 * 2),           -- 얼음
(10, 'Coffee', 'Extra', 8, '콜드브루라떼', 1, 'ea', 80, 80),                 -- 컵(extra size)

-- 헤이즐넛라떼(엑스트라) 1330원
(11, 'Coffee', 'Extra', 1, '헤이즐넛라떼', 30, 'g', 20, 30 * 20),            -- 원두(에스프레소)
(11, 'Coffee', 'Extra', 5, '헤이즐넛라떼', 20, 'ml', 10, 20 * 10),           -- 헤이즐넛 시럽
(11, 'Coffee', 'Extra', 4, '헤이즐넛라떼', 150, 'ml', 3, 150 * 3),           -- 우유
(11, 'Coffee', 'Extra', 8, '헤이즐넛라떼', 1, 'ea', 80, 80),                 -- 컵(extra size)

-- 헤이즐넛아메리카노(엑스트라) 910원
(12, 'Coffee', 'Extra', 1, '헤이즐넛아메리카노', 30, 'g', 20, 30 * 20),       -- 원두(에스프레소)
(12, 'Coffee', 'Extra', 5, '헤이즐넛아메리카노', 20, 'ml', 10, 20 * 10),     -- 헤이즐넛 시럽
(12, 'Coffee', 'Extra', 2, '헤이즐넛아메리카노', 150, 'ml', 0.2, 150 * 0.2), -- 물
(12, 'Coffee', 'Extra', 8, '헤이즐넛아메리카노', 1, 'ea', 80, 80),           -- 컵(extra size)

-- 연유라떼(엑스트라) 1690원
(13, 'Coffee', 'Extra', 1, '연유라떼', 30, 'g', 20, 30 * 20),               -- 원두(에스프레소)
(13, 'Coffee', 'Extra', 6, '연유라떼', 250, 'ml', 2, 250 * 2),              -- 얼음
(13, 'Coffee', 'Extra', 4, '연유라떼', 150, 'ml', 3, 150 * 3),              -- 우유
(13, 'Coffee', 'Extra', 5, '연유라떼', 30, 'g', 2, 30 * 2),                 -- 연유
(13, 'Coffee', 'Extra', 8, '연유라떼', 1, 'ea', 80, 80),                  -- 컵(extra size)

-- 에스프레소 680원
(14, 'Coffee', 'Extra', 1, '에스프레소', 30, 'g', 20, 30 * 20),      -- 원두(에스프레소)
(14, 'Coffee', 'Extra', 8, '에스프레소', 1, 'ea', 80, 80);      
