...
(1, '마늘', '식자재', 'g', 10, '2024-04-05 10:45:00'),          -- 10원/g
(1, '물', '식자재', 'ml', 0.2, '2024-04-05 10:50:00'),            -- 1원/ml
(1, '밀가루', '식자재', 'g', 1.5, '2024-04-05 10:55:00'),       -- 1.5원/g
(1, '베이킹소다', '식자재', 'g', 2, '2024-04-05 11:10:00'),     -- 4원/g
(1, '베이킹파우더', '식자재', 'g', 2, '2024-04-05 11:15:00'),   -- 2원/g
(1, '소금', '식자재', 'g', 1, '2024-04-05 11:30:00'),           -- 2원/g
(1, '시나몬 가루', '식자재', 'g', 6, '2024-04-05 11:40:00'),    -- 6원/g
(1, '올리브오일', '식자재', 'ml', 10, '2024-04-05 11:50:00'),   -- 10원/ml
(1, '이스트', '식자재', 'g', 3, '2024-04-05 12:00:00'),         -- 3원/g
(1, '파슬리', '식자재', 'g', 4, '2024-04-05 12:05:00'),         -- 4원/g
(1, '꿀', '식자재', 'g', 10, '2024-04-05 10:40:00'),            -- 25원/g
(1, '바닐라 추출물', '식자재', 'ml', 100, '2024-04-05 11:00:00'),-- 10원/ml
(1, '버터', '식자재', 'g', 12, '2024-04-05 11:05:00'),          -- 12원/g
(1, '생크림', '식자재', 'g', 10, '2024-04-05 11:20:00'),        -- 20원/g
(1, '설탕', '식자재', 'g', 0.5, '2024-04-05 11:25:00'),         -- 0.5원/g
(1, '팥앙금', '식자재', 'g', 7, '2024-04-05 12:10:00'),  
(1, '우유', '식자재', 'ml', 3, '2024-04-05 12:10:00'),  
-- 커피 재료
(2, '원두(에스프레소)', '식자재', 'g', 20, '2024-04-06 09:00:00'),     -- 3원/g
(2, '카라멜시럽', '식자재', 'ml', 15, '2024-04-06 09:10:00'),        -- 1.5원/ml
(2, '초콜릿 시럽', '식자재', 'ml', 6, '2024-04-06 09:20:00'),        -- 1.5원/ml
(2, '콜드브루 원액', '식자재', 'ml', 6, '2024-04-06 09:30:00'),        -- 4원/ml
(2, '연유', '식자재', 'g', 2, '2024-04-06 09:40:00'), 
(2, '얼음', '식자재', 'ml', 15, '2024-04-06 09:40:00'),                 -- 2원/g


-- 부자재 (3번 공급업체)
(3, '포장지', '포장재', 20, '2024-04-06 11:00:00'),
(3, '컵(regular size)', '부자재', 70, '2024-04-06 11:10:00'),
(3, '컵(extra size)', '부자재', 80, '2024-04-06 11:20:00'),
(3, '빨대', '부자재', 3, '2024-04-06 11:30:00'),
(3, '캐리어', '부자재', 2, '2024-04-06 11:40:00');
...
-- 에스프레소 400원
(14, 1, '에스프레소', 20, 'g', 20, 20 * 20),  -- 원두(에스프레소)
(14, 7, '에스프레소', 1, 'ea', 70, 70),      -- 컵(regular size)
...
-- 에스프레소(엑스트라) 400원 (에스프레소는 용량 변경 없음)
(14, 1, '에스프레소(엑스트라)', 20, 'g', 20, 20 * 20),  -- 원두(에스프레소)
(14, 8, '에스프레소(엑스트라)', 1, 'ea', 80, 80);       -- 컵(extra size)
