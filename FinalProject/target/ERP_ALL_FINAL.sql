...
CREATE TABLE ERP.Product (
    ...
    OnKiosk VARCHAR(30) NULL CHECK (OnKiosk IN ('Y', 'N')), -- 제품이 키오스크에 있는지 확인용 
    Recommend VARCHAR(30) NULL CHECK (Recommend IN ('Y', 'N')), -- 제품 추천 여부(키오스크용)
...
('빼빼로', 'bread', null, null, null, null, 'N', 'N', '오직 빼빼로데이에만 맛볼수 있는 빼빼로빵', 3);
-- 커피 insert문
...
INSERT INTO ERP.WorkOrders (ProductID, ProductName, Quantity, StartDate, EndDate, Priority, etc)
VALUES
    (5, '라우겐', 120, '2024-11-010 08:00:00', '2024-11-10 16:00:00', 'Low', '품질 검사 대기');
...
VALUES 
    ...
    (8, 40, 8, '꿀버터바게트', '합격', '2024-11-01 21:00:00', '검사에서 결함 발견'),
    ...
    (16, 50, 4, '꽈베기', '합격', '2024-11-02 21:00:00', '검사에서 결함 발견'),
    ...
    (24, 50, 12, '카라멜 러스크', '합격', '2024-11-03 21:00:00', '검사에서 결함 발견'),
    ...
    (32, 20, 8, '꿀버터바게트', '합격', '2024-11-04 21:00:00', '검사에서 결함 발견'),
...
(39, 30, 3, '고구마케이크빵', '합격', '2024-11-05 20:00:00', '검사에서 결함 발견'),
...
(48, 40, 12, '카라멜 러스크', '합격', '2024-11-06 21:00:00', '검사에서 결함 발견'),
...
(56, 30, 8, '꿀버터바게트', '합격', '2024-11-07 21:00:00', '검사에서 결함 발견'),
...
(64, 20, 4, '꽈베기', '합격', '2024-11-08 21:00:00', '검사에서 결함 발견'),
...
(71, 20, 11, '찹쌀브레드', '합격', '2024-11-09 20:00:00', '검사에서 결함 발견'),
...
VALUES
    (8, 8, 40, 8, '꿀버터바게트', '외관 결함', 2, '불량 형태의 변형 발생', '완료', 5, '페기 완료'),
	(48, 48, 40, 12, '카라멜 러스크', '질감 불량', 2, '바삭함이 덜해 품질 저하', '완료', 5, '페기 완료'),
    (56, 56, 30, 8, '꿀버터바게트', '내부 결함', 3, '반죽 속 공기층 불량', '완료', 5, '페기 완료'),
    (71, 71, 20, 11, '찹쌀브레드', '내부 결함', 1, '찹쌀 식감 부족', '완료', 5, '페기 완료'),
    (79, 79, 25, 7, '생크림소보로', '내부 결함', 2, '크림의 밀도가 낮음', '미처리', 5, '페기 대기'),
    (88, 88, 20, 4, '꽈베기', '형태 불량', 1, '전형적인 모양을 벗어남', '미처리', 5, '페기 대기');
...
VALUES
    ...
    (8, 8, 38, 8, '꿀버터바게트', '2024-11-01', '입고 완료'),
    ...
    (48, 48, 38, 12, '카라멜 러스크', '2024-11-06', '입고 완료'),
    ...
    (56, 56, 27, 8, '꿀버터바게트', '2024-11-07', '입고 완료'),
    ...
    (71, 71, 19, 11, '찹쌀브레드', '2024-11-09', '입고 완료'),
    ...
    (81, 81, 45, 9, '애플파이', '2024-11-11', '입고 완료'),
    (82, 82, 30, 10, '우유도넛', '2024-11-11', '입고 완료'),
    (83, 83, 40, 11, '찹쌀브레드', '2024-11-11', '입고 완료'),
    (84, 84, 20, 12, '카라멜 러스크', '2024-11-11', '입고 완료'),
    (85, 85, 50, 1, '갈릭꽈베기', '2024-11-11', '입고 완료'),
    (86, 86, 25, 2, '단팥도넛', '2024-11-11', '입고 완료'),
    (87, 87, 30, 3, '고구마케이크빵', '2024-11-11', '입고 완료');
