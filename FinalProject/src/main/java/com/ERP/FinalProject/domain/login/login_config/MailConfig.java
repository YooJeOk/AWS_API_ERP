package com.ERP.FinalProject.domain.login.login_config;
...
public class MailConfig {
    ...
    public JavaMailSender NaverMailService(){
        ...
        javaMailSender.setUsername("fullstack0408"); // 네이버 아이디
        javaMailSender.setPassword("fullstack0408!"); // 네이버 비밀번호
