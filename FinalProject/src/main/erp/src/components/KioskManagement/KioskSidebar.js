        ...
        >
            ...
            <div className="dropdown">
                    ...
                    <ul className="dropdown-menu">
                        <li><Link to="/KioskSelect">상품 조회</Link></li>
                        <li><Link to="/KioskSelect">상품 가격 조정</Link></li>
                        <li><Link to="/KioskSelect">상품 추천여부 설정</Link></li>
                        <li><Link to="/KioskSelect">상품 삭제</Link></li>
                    </ul>
                </div>
