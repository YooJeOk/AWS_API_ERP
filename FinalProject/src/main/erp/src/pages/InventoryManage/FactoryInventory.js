...
const FactoryInventory = () => {
    ...
    const fetchProductInventory = useCallback(async () => {
        const response = await fetch(`http://localhost:8080/api/factory/inventory/products?page=${productPage}&size=5`);
    ...
    const fetchMaterialInventory = useCallback(async () => {
        const response = await fetch(`http://localhost:8080/api/factory/inventory/materials?page=${materialPage}&size=5`);
        const data = await response.json();
